...
public class JPA_CREATE_DDL_Test {
    ...
    public static void main(String[] args) {
        ...
        sb.append("JPA_COLUMNTYPE").append("\t\t").append("|");
        ...
        sb.append("DB_COLUMNTYPE").append("\t\t").append("|");
        ...
        for (Entry<String, ColumnCompareInfo> entryTemp : map.entrySet()) {
            sb.append(StringUtils.rightPad(entryTemp.getKey(), 32)).append("\t\t").append("|");
            
            TableColumnDef column = entryTemp.getValue().getSourceColumn();
            sb.append(column.getColumnType()).append("\t\t").append("|");
