...
/**
 * Ehcache的MultiValueMap实现<br/>
 *      1、从该map中get对象实际是get了一个Object的copy 与 SimpleMultiValueEhcacheMap 在此处有较大区别
 * <功能详细描述>
 * 
 * @author  brady
 ...
 * @since  [产品/模块版本]
 */
public class SynchronizedMultiValueEhcacheMap<K extends Serializable, V extends Serializable>
     ...
     * <默认构造函数>
     */
    public SynchronizedMultiValueEhcacheMap(String id, Ehcache ehcache) {
    ...
    public SynchronizedMultiValueEhcacheMap(String id, Ehcache ehcache,
        ...
        realMap = new ConcurrentHashMap<K, List<V>>(realMap);
