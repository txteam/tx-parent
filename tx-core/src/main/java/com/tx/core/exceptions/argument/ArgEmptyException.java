 ...
 * @since  [产品/模块版本]
 */
public class ArgEmptyException extends ArgIllegalException {
    ...
    protected ErrorCode error() {
        return SILErrorCodeEnum.ARG_EMPTY_ERROR;
    }
    ...
    /** <默认构造函数> */
    public ArgEmptyException(String message, Throwable cause) {
        super(message, cause);
    }
    
    /** <默认构造函数> */
    public ArgEmptyException(String message) {
        super(message);
    }
}
