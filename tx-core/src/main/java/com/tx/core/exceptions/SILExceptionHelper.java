...
public abstract class SILExceptionHelper {
    ...
    //     * @see [类、类#方法、类#成员]
    //    */
    //    public static Constructor<? extends SILException> getSILExceptionConstructor(int errorCode, String message,
    //            Throwable cause, Class<? extends SILException> defaultType) {
    //        Constructor<? extends SILException> e = doGetSILExceptionConstructor(errorCode, message, cause, defaultType);
    //        return e;
    //    }
    //    
    //    /**
    ...
    //     * @see [类、类#方法、类#成员]
    //    */
    //    private static Constructor<? extends SILException> doGetSILExceptionConstructor(int errorCode, String message,
    //            Throwable cause, Class<? extends SILException> defaultType) {
    //        Class<? extends SILException> type = ERROR_CODE_REGISTRY.getErrorType(errorCode);
    //        if (defaultType == null) {
    //            defaultType = SILException.class;
    //        }
    //        Constructor<? extends SILException> exception = null;
    //        if (type == null && errorCode >= 0) {
    //            //errorCode >= 0时，直接使用SILException
    //            if (cause == null) {
    //                exception = ConstructorUtils.getAccessibleConstructor(SILException.class, String.class);
    //            } else {
    //                exception = ConstructorUtils.getAccessibleConstructor(SILException.class, String.class,Throwable.class);
    //            }
    //        } else if (type == null) {
    //            //errorCode < 0时，使用defaultType对应的类
    //            if (cause == null) {
    //                try {
    //                    exception = ConstructorUtils.getAccessibleConstructor(defaultType, String.class);
