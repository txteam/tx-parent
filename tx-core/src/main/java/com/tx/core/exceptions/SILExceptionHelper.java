...
public abstract class SILExceptionHelper {
    ...
    /**
      ...
      * @see [类、类#方法、类#成员]
     */
    public static SILException newSILException(String message,
    ...
    public static SILException newSILException(int errorCode, String message,
            Class<? extends SILException> defaultType) {
        SILException e = doNewSILException(errorCode,
                message,
                null,
                defaultType);
        return e;
    ...
    /**
      ...
      * @see [类、类#方法、类#成员]
     */
    private static SILException doNewSILException(int errorCode,
        ...
        if (type == null && errorCode >= 0) {
            ...
            if (cause == null) {
                try {
                    exception = ConstructorUtils.invokeConstructor(defaultType,
                            message);
            ...
            if (cause == null) {
                try {
                    exception = ConstructorUtils.invokeConstructor(type,
                            message);
                } catch (NoSuchMethodException | IllegalAccessException
