 ...
 * @since  [产品/模块版本]
 */
public class ResourcePropertiesFactoryBean implements ApplicationContextAware,
        InitializingBean, FactoryBean<Properties> {
    
    private Logger logger = LoggerFactory.getLogger(ResourcePropertiesFactoryBean.class);
