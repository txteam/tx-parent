 ...
 * @since  [产品/模块版本]
 */
public class DbcpDataSourceFinder implements DataSourceFinder {
    
    private static Logger logger = LoggerFactory.getLogger(DbcpDataSourceFinder.class);
    ...
    /** <默认构造函数> */
    public DbcpDataSourceFinder() {
        super();
    }
    
    /** <默认构造函数> */
    public DbcpDataSourceFinder(String driverClassName, String url,
    ...
    public DataSource getDataSource() {
        ...
        if (DbcpDataSourceFinder.dataSourceMap.containsKey(this.url)) {
            return DbcpDataSourceFinder.dataSourceMap.get(this.url);
        }
        ...
        try {
            ...
            DbcpDataSourceFinder.dataSourceMap.put(this.url, bds);
        } catch (Exception e) {
