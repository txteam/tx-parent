...
public class JPAEntityTypeRegistry {
    ...
    */
     ...
     * @see [类、类#方法、类#成员]
     */
    public static int getDefaultLengthByType(Class<?> type) {
        AssertUtils.notNull(type, "type is null.");
     ...
     * @see [类、类#方法、类#成员]
     */
    public static int getDefaultScaleByType(Class<?> type) {
        AssertUtils.notNull(type, "type is null.");
     ...
     * @see [类、类#方法、类#成员]
     */
    public static int getDefaultLengthByName(Class<?> type, String name) {
        AssertUtils.notNull(type, "type is null.");
     ...
     * @see [类、类#方法、类#成员]
     */
    public static int getDefaultScaleByName(Class<?> type, String name) {
        AssertUtils.notNull(type, "type is null.");
        AssertUtils.notEmpty(name, "name is null.");
