...
//    private static XStream TableDefinitionConfigXstream = XstreamUtils
//            .getXstream(TableDefinitionConfig.class);
//    
//    /** 脚本所在路径 */
...
//        
//        try (InputStream in = scriptResourceTemp.getInputStream()) {
//            String context = IOUtils.toString(in, "UTF-8");
//            context = replaceContext(context, this.replaceDataMap);
//            this.tableDefinitionConfig = (TableDefinitionConfig) TableDefinitionConfigXstream
//                    .fromXML(context);
//        } catch (IOException e) {
...
//      * @see [类、类#方法、类#成员]
//     */
//    private String replaceContext(String sourceContext,
//            Map<String, String> replaceMap) {
//        String resContext = sourceContext;
//        for (Entry<String, String> entryTemp : replaceMap.entrySet()) {
//            String searchString = this.prefixPlaceHolder
//                    + entryTemp.getKey().trim() + this.suffixPlaceHolder;
//            String replacement = entryTemp.getValue();
//            resContext = StringUtils.replace(resContext,
//                    searchString,
//                    replacement);
//        }
//        return resContext;
...
//        for (DataSourceScriptConfig dataSourceScriptConfigTemp : this.tableDefinitionConfig
//                .getDataSourceScriptConfigs()) {
//            if (dataSourceType
//                    .equals(dataSourceScriptConfigTemp.getDataSourceType())) {
...
//        
//        String createTableScript = dataSourceScriptConfig
...
//                new Object[] { dataSourceType });
//        
//        String updateTableScript = getUpdateTableScriptByDataSourceScriptConfig(
//                dataSourceScriptConfig, sourceTableVersion);
...
//        if (!CollectionUtils
//                .isEmpty(dataSourceScriptConfig.getUpdateTableScripts())) {
//            for (UpdateTableScriptConfig temp : dataSourceScriptConfig
//                    .getUpdateTableScripts()) {
//                targetVersion2UpdateTableScriptConfigMap
//                        .put(temp.getTargetVersion(), temp);
//            }
//        }
//        
//        //如果目标版本不包含当前版本
//        if (!targetVersion2UpdateTableScriptConfigMap
//                .containsKey(tableVersion())) {
//            return dataSourceScriptConfig.getDefaultUpdateTableScript();
//        }
//        
//        //如果包含则进行递归查找
//        LinkedList<UpdateTableScriptConfig> updateTableList = new LinkedList<UpdateTableScriptConfig>();
//        UpdateTableScriptConfig updateTableScriptConfigTemp = targetVersion2UpdateTableScriptConfigMap
//                .get(tableVersion());
//        boolean flag = false;
//        do {
//            flag = false;
//            String targetVersion = updateTableScriptConfigTemp
//                    .getTargetVersion();
//            String sourceVersion = updateTableScriptConfigTemp
//                    .getSourceVersion();
//            //targetVersion不能为空
...
//                    return sb.toString();
//                }
//            } else if (targetVersion2UpdateTableScriptConfigMap
//                    .containsKey(sourceVersion)) {
//                updateTableScriptConfigTemp = targetVersion2UpdateTableScriptConfigMap
//                        .get(sourceVersion);
//                flag = true;
//            } else {
//                flag = false;
