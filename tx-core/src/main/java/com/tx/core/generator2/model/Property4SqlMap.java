...
public class Property4SqlMap {
    ...
    public Property4SqlMap() {
        super();
    }
    
    public Property4SqlMap(boolean isSimpleType, String propertyName,
        ...
        this.isSameName = this.columnName.toUpperCase()
                .equals(this.propertyName.toUpperCase());
    }
