...
public interface TemplateTableDao {
    ...
    /**
      * 根据指定查询条件以及排序列查询TemplateTable列表
      * auto generate
      * <功能详细描述>
      * @param params
      * @param orderList
    ...
    /**
      ...
      * @return [参数说明]
      * 
      * @return PagedList<TemplateTable> [返回类型说明]
      * @exception throws [异常类型] [异常说明]
      * @see [类、类#方法、类#成员]
     */
    //auto generate
    ...
    /**
      * 更新TemplateTable实体，
      * auto generate
      * 1、传入TemplateTable中主键不能为空
      * <功能详细描述>
      * @param updateTemplateTableRowMap
      * @return [参数说明]
      * 
      * @return int [返回类型说明]
      * @exception throws [异常类型] [异常说明]
