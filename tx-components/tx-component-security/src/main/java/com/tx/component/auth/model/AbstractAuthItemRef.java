 ...
 * @since  [产品/模块版本]
 */
public abstract class AbstractAuthItemRef implements AuthRef {
    
    /** 注释内容 */
    private static final long serialVersionUID = 7403823613592297657L;
    
    /** <默认构造函数> */
    public AbstractAuthItemRef() {
        super();
    }
    
    /** <默认构造函数> */
    public AbstractAuthItemRef(Auth auth) {
        super();
    ...
    /** <默认构造函数> */
    public AbstractAuthItemRef(String authId) {
        super();
    ...
    public String toString() {
        return MessageFormatter.arrayFormat(
                "authItemRef: {refId{},authId:{},refId:{},refType:{},id:{},}",
                new Object[] { this.refId, this.authId, this.refId,
                        this.refType, this.id })
                .getMessage();
    }
}
