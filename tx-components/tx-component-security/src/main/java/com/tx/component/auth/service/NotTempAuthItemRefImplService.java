...
//     * @see [类、类#方法、类#成员]
//     */
//    public List<AuthRefItem> queryAuthItemRefListByRefTypeAndRefId(
...
//      * @see [类、类#方法、类#成员]
//     */
//    public List<AuthRefItem> queryAuthItemRefListByAuthTypeAndRefTypeAndRefId(
...
//      * @see [类、类#方法、类#成员]
//     */
//    public List<AuthRefItem> queryAuthItemRefListByRefTypeAndAuthItemId(
...
//      * @see [类、类#方法、类#成员]
//     */
//    public List<AuthRefItem> queryAuthItemRefListByAuthTypeAndRefTypeAndAuthItemId(
...
//        List<AuthRefItem> authItemRefImplList = queryAuthItemRefListByRefTypeAndAuthItemId(authRefType,
//                authItemId,
//                systemId,
//                tableSuffix);
//        if (authItemRefImplList != null) {
//            for (AuthRefItem refTemp : authItemRefImplList) {
...
//                systemId,
//                tableSuffix);
//        Map<String, AuthRefItem> dbAuthItemRefMap = new HashMap<String, AuthRefItem>();
//        if (authItemRefImplList != null) {
//            for (AuthRefItem refTemp : authItemRefImplList) {
//                srcAuthRefIds.add(refTemp.getRefId());
...
//                deleteRefIdList);
//        //生成需要插入权限引用历史表的数据
//        List<AuthRefItem> needInsertToHis = new ArrayList<AuthRefItem>();
...
//        List<AuthRefItem> authItemRefImplList = queryAuthItemRefListByRefTypeAndRefId(authRefType,
//                refId,
//                systemId,
//                tableSuffix);
//        Map<String, AuthRefItem> dbAuthItemRefMap = new HashMap<String, AuthRefItem>();
...
//        //存储前,获取原有的权限引用
//        List<String> srcAuthItemIds = new ArrayList<String>();
//        List<AuthRefItem> authItemRefImplList = queryAuthItemRefListByAuthTypeAndRefTypeAndRefId(authType,
//                authRefType,
//                refId,
//                systemId,
//                tableSuffix);
...
//        
//        //如果存在需要删除的权限引用项
//        List<AuthRefItem> authItemRefList = new ArrayList<AuthRefItem>();
//        for (String authItemIdTemp : needDeleteAuthItemIds) {
//            AuthRefItem authItemRef = new AuthRefItem();
...
//            List<AuthRefItem> needInsertToHisAuthItemRefImpls,
//            String tableSuffix) {
