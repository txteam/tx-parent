 ...
 * @since  [产品/模块版本]
 */
public class SecurityTableInitializer extends AbstractTableInitializer
    ...
    /** <默认构造函数> */
    public SecurityTableInitializer() {
        super();
    }
    
    /** <默认构造函数> */
    public SecurityTableInitializer(TableDDLExecutor tableDDLExecutor) {
        super();
