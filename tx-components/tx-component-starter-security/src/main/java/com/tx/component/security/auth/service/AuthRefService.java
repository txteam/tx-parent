...
import com.tx.component.security.auth.model.AuthRef;
...
public interface AuthRefService {
     ...
     * @see [类、类#方法、类#成员]
     */
    default List<AuthRef> queryListByRefMap(
     ...
     * @see [类、类#方法、类#成员]
     */
    default List<AuthRef> queryListByRef(Boolean valid, String refType,
        ...
        List<AuthRef> resList = queryList(valid, params);
        return resList;
    }
     ...
     * @see [类、类#方法、类#成员]
     */
    default List<AuthRef> queryListByAuthId(Boolean valid, String authId,
