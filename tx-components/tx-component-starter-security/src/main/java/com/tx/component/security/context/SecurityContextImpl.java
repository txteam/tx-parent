 ...
 * @since [产品/模块版本]
 */
public class SecurityContextImpl extends SecurityContextBuilder
    ...
    //        
    //        List<RoleRef> authItemRefList = null;
    //        
    ...
    //        if (isSuperAdmin) {
    //            //如果是超级管理员则拥有所有权限项的引用
    //            authItemRefList = new ArrayList<RoleRef>();
    //            for (Auth authItemTemp : authItemMapping.values()) {
    ...
    //        List<RoleRef> authItemRefList = AuthSessionContext.getAuthRefListFromSession(authItem.getId());
    ...
    //      * @see [类、类#方法、类#成员]
    //     */
    //    public List<RoleRef> queryAuthItemRefListByAuthRefTypeAndRefId(
    ...
    //                this.tableSuffix);
    //        
    //        List<RoleRef> resList = changeAuthItemRefImplListToAuthItemRefList(authItemRefImplList);
    //        return resList;
    //    }
    //    
    //    /**
    ...
    //      * @see [类、类#方法、类#成员]
    //     */
    //    public List<RoleRef> queryAuthItemRefListByAuthRefTypeAndAuthItemId(
    ...
    //      * @see [类、类#方法、类#成员]
    //     */
    //    public List<RoleRef> queryAuthItemRefListByRefType2RefIdMapping(
    ...
    //      * @see [类、类#方法、类#成员]
    //     */
    //    private List<RoleRef> changeAuthItemRefImplListToAuthItemRefList(
    //            List<AuthRefItem> authItemRefImplList) {
    //        List<RoleRef> resList = new ArrayList<RoleRef>();
