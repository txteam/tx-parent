...
//    
//    private SimpleSqlMapMapper simpleSqlMapMapper;
//    
//    /** <默认构造函数> */
//    public DefaultBasicDataExecutor(DataSource dataSource,
//            CacheManager cacheManager, Class<T> type) {
//        super(dataSource, cacheManager, type);
//    }
//    
//    /**
//     * @param pk
...
//            e.printStackTrace();
//        }
//        getJdbcTemplate().query(simpleSqlMapMapper.findSql(),
//                simpleSqlMapMapper.getPKSetter(obj),
//                simpleSqlMapMapper.getSelectRowCallbackHandler(res));
//        return res;
//    }
//    
//    /**
...
//        //getJdbcTemplate().query(simpleSqlMapMapper.queryPagedSql(dialect, obj, pageIndex, pageSize);
//        return null;
//    }
//    
//    /**
