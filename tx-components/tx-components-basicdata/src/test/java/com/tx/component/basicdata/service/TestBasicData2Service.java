...
public class TestBasicData2Service {
    ...
    */
    ...
    public void insertTestBasicData2(TestBasicData2 testBasicData2) {
        ...
        AssertUtils.notEmpty(testBasicData2.getCode(), "testBasicData2.code is empty.");
    ...
    */
    public PagedList<TestBasicData2> queryTestBasicData2PagedList(
        ...
        //根据实际情况，填入排序字段等条件，根据是否需要排序，选择调用dao内方法
        PagedList<TestBasicData2> resPagedList = this.testBasicData2Dao.queryTestBasicData2PagedList(params, pageIndex, pageSize);
