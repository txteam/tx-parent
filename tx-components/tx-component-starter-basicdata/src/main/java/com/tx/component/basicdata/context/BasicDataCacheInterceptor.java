 ...
 * @since  [产品/模块版本]
 */
public class BasicDataCacheInterceptor extends ServiceSupportCacheInterceptor {
    
    /** <默认构造函数> */
    public BasicDataCacheInterceptor() {
        super();
    }
    
    /** <默认构造函数> */
    public BasicDataCacheInterceptor(Cache cache) {
        super(cache);
    }
