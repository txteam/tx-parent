...
import com.tx.component.basicdata.service.AbstractTreeAbleBasicDataService;
...
public class ${service.entityTypeSimpleName}Service extends AbstractTreeAbleBasicDataService<${service.entityTypeSimpleName}>{
