...
//import com.tx.component.file.resource.driver.FileResourceDriver;
...
// * @since [产品/模块版本]
// */
//public class OSSFileDefinitionResourceDriver implements FileResourceDriver {
//    
//    /** endpoint */
...
//        
//        // 创建OSSClient实例
//        CredentialsProvider provider = new DefaultCredentialProvider(this.accessKeyId,
//                this.secretAccessKey);
//        OSSClient client = new OSSClient(this.endpoint, provider, conf);
//        return client;
//    }
//    
//    /**
...
//                this.bucketName, this.ossClient);
//        return fdResource;
//    }
//    
//    /**
