...
public class DRLByteDroolsRuleRegister implements
    ...
    public Set<RuleItemParam> ruleItemParam() {
        Set<RuleItemParam> resSet = RuleItemParamHelper.getRuleItemParamSet(DRLByteDroolsRuleParamEnum.class);
        return resSet;
    }
     ...
     */
    @Override
    public DRLByteDroolsRule registe(RuleItem ruleItem) {
        DRLByteDroolsRule res = new DRLByteDroolsRule(ruleItem);
        return res;
    }
}
