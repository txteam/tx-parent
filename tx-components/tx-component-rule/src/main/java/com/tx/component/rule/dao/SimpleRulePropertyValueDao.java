 ...
 * @since  [产品/模块版本]
 */
public interface SimpleRulePropertyValueDao {
    
    /**
      * 插入SimpleRulePropertyValue对象实体
      * 1、auto generate
      * <功能详细描述>
    ...
    /**
      * 批量插入SimpleRulePropertyValue对象实体
      * <功能详细描述>
      * @param condition [参数说明]
      * 
      * @return void [返回类型说明]
      ...
      * @see [类、类#方法、类#成员]
     */
    public void batchInsertSimpleRulePropertyValue(List<SimpleRulePropertyValue> condition);
    
    /**
      * 删除SimpleRulePropertyValue对象
      * 1、auto generate
      * 2、根据入参条件进行删除
      * <功能详细描述>
      * @param condition [参数说明]
    ...
    /**
      * 根据条件查询SimpleRulePropertyValue列表
      * auto generate
      * <功能详细描述>
      * @param params
      * @return [参数说明]
    ...
    /**
      * 根据指定查询条件以及排序列查询SimpleRulePropertyValue列表
      * auto generate
      * <功能详细描述>
      * @param params
      * @param orderList
    ...
    /**
      * 根据条件查询SimpleRulePropertyValue列表总数
      * auto generated
      * <功能详细描述>
      * @param params
      * @return [参数说明]
    ...
    /**
      ...
      * @return [参数说明]
      * 
      * @return PagedList<SimpleRulePropertyValue> [返回类型说明]
      * @exception throws [异常类型] [异常说明]
      * @see [类、类#方法、类#成员]
     */
    //auto generate
    ...
    /**
      * 分页查询SimpleRulePropertyValue列表，传入排序字段
      * auto generate
      * <功能详细描述>
      * @param params
      * @param pageIndex
    ...
    /**
      * 更新SimpleRulePropertyValue实体，
      * auto generate
      * 1、传入SimpleRulePropertyValue中主键不能为空
      * <功能详细描述>
      * @param updateSimpleRulePropertyValueRowMap
      * @return [参数说明]
      * 
      * @return int [返回类型说明]
      * @exception throws [异常类型] [异常说明]
