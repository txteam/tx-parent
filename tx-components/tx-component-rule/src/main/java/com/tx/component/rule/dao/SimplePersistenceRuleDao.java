 ...
 * @since  [产品/模块版本]
 */
public interface SimplePersistenceRuleDao {
    
    /**
      * 插入SimplePersistenceRule对象实体
      * 1、auto generate
      * <功能详细描述>
    ...
    /**
      * 根据指定查询条件以及排序列查询SimplePersistenceRule列表
      * auto generate
      * <功能详细描述>
      * @param params
      * @param orderList
    ...
    /**
      * 根据条件查询SimplePersistenceRule列表总数
      * auto generated
      * <功能详细描述>
      * @param params
      * @return [参数说明]
    ...
    /**
      * 分页查询SimplePersistenceRule列表，传入排序字段
      * auto generate
      * <功能详细描述>
      * @param params
      * @param pageIndex
