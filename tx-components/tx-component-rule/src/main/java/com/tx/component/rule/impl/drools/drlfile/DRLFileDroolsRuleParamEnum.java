...
// * @since  [产品/模块版本]
// */
//public enum DRLFileDroolsRuleParamEnum implements
//        RuleItemParamEnumInterface<DRLFileDroolsRule> {
//    
//    /** 对应规则项bean实例 */
//    DRL_FILE(RuleItemParamTypeEnum.OBJECT, false, true, null, "");
//    
//    /** 规则项目参数类型 */
...
//    
//    /** <默认构造函数> */
//    private DRLFileDroolsRuleParamEnum(RuleItemParamTypeEnum type,
