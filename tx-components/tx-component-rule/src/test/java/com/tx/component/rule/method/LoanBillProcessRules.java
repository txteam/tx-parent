...
public class LoanBillProcessRules {
    ...
    public void minAgeRule(TestPojo testPojo, TestPojoDao testPojoDao,
            TestPojoAutoTest tt, @RuleRequestParam Map<String, Object> facts,
            String test,
            ValueWrapper<List<ProcessRule>> violateProcessRuleListValueWrapper) {
        ...
        ValueWrapperUtils.addValue(violateProcessRuleListValueWrapper,
                new ProcessRule("年龄不能小于18岁"));
    }
