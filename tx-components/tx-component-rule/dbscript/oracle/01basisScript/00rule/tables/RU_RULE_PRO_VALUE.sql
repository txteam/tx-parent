...
(
	ruleId varchar2(64) not null,		   		  --对应规则id
	paramKey varchar2(64) not null,				  --对应属性key
	simpleRulePropertyParam varchar2(64) not null,	  --对应属性
	paramValueOrdered integer default 0 not null, --对应属性排序值
	paramValue varchar2(2000),					  --对应属性值
	primary key(ruleId)
);
