...
public class ConfigPropertiesSetting implements TreeAble<List<ConfigPropertiesSetting>, ConfigPropertiesSetting>{
    ...
    private List<ConfigPropertiesSetting> childs;
    ...
    public String getKey() {
        if(ConfigPropertiesSetting.TYPE_LEAF.equals(this.type)){
     ...
     */
    public void setViewAble(boolean isVisible) {
        this.isViewAble = isVisible;
    }
     ...
     * @return 返回 childs
     */
    public List<ConfigPropertiesSetting> getChilds() {
        if(this.childs != null && this.childs.size() > 0){
            String parentKey = this.getKey();
            for(ConfigPropertiesSetting proSettingTemp : this.childs){
     ...
     * @param 对childs进行赋值
     */
    public void setChilds(List<ConfigPropertiesSetting> childs) {
        this.childs = childs;
    }
