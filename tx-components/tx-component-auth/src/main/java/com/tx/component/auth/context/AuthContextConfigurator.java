 ...
 * @since [产品/模块版本]
 */
public class AuthContextConfigurator implements ApplicationContextAware, InitializingBean {
    
    /** 日志记录器 */
    private static final Logger logger = LoggerFactory.getLogger(AuthContextConfigurator.class);
    
    /** 业务日志记录器：默认使用logback日志记录器  */
    @SuppressWarnings("unused")
    private Logger serviceLogger = LoggerFactory.getLogger(AuthContextConfigurator.class);
     ...
     * <默认构造函数>
     */
    public AuthContextConfigurator() {
    }
