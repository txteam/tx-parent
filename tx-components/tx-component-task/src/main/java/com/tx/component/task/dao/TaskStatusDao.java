...
public interface TaskStatusDao {
    ...
    /**
      * 批量更新TaskStatus实体，
      * auto generate
      * 1、传入TaskStatus中主键不能为空
      * <功能详细描述>
      * @param updateTaskStatusRowMap
      * @return [参数说明]
      * 
      * @return int [返回类型说明]
      * @exception throws [异常类型] [异常说明]
    ...
    */
    ...
    /**
      ...
      * @return [参数说明]
      * 
      * @return PagedList<TaskStatus> [返回类型说明]
      * @exception throws [异常类型] [异常说明]
      * @see [类、类#方法、类#成员]
     */
    //auto generate
