 ...
 * <修改描述:>
 */
package com.tx.component.servicelogger.parser;
 ...
 * @since [产品/模块版本]
 */
public class ServiceLoggerParser<T> implements Serializable, Cloneable {
    ...
    /** <默认构造函数> */
    public ServiceLoggerParser(String tableName, String pkName,
            Dialect dialect) {
        super();
    ...
    /** <默认构造函数> */
    public ServiceLoggerParser(Dialect dialect) {
        super();
    ...
    public void addGetter2GetterColumnInfoMapping(JpaMetaClass<?> jpaMetaClass,
        ...
        this.getter2getterColumnInfo.put(getterName,
                new Getter2ColumnInfo(jpaMetaClass, getterName));
    }
    ...
    public void addGetter2columnMapping(String getterName, String columnName,
        ...
        this.getter2columnNameMapping.put(getterName.trim(),
                columnName.trim().toUpperCase());
    ...
    public String insertSql() {
        ...
        for (Entry<String, String> entryTemp : getter2columnNameMapping
                .entrySet()) {
            SqlBuilder.VALUES(entryTemp.getValue(), "?");
        }
        for (Entry<String, String> entryTemp : otherColumn2expressionMapping
                .entrySet()) {
        ...
        PreparedStatementSetter res = new PreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps) throws SQLException {
                ...
                for (Entry<String, String> entryTemp : getter2columnNameMapping
                    ...
                    Class<?> getterType = getter2JavaTypeMapping
                            .get(propertyTemp);
    ...
    public String deleteSql() {
        ...
        SqlBuilder.WHERE(
                this.getter2columnNameMapping.get(this.pkName) + " = ? ");
    ...
    public RowMapper<T> getSelectRowMapper() {
        ...
        RowMapper<T> rowMapper = new RowMapper<T>() {
            ...
            public T mapRow(ResultSet rs, int rowNum) throws SQLException {
                ...
                MetaObject metaObject = MetaObjectUtils
                        .forObject(newObjInstance);
                ...
                for (Entry<String, String> entryTemp : getter2columnNameMapping
                    ...
                    if (finalClassReflector.getSetterNames()
                        ...
                        Class<?> type = getter2JavaTypeMapping
                                .get(propertyName);
                        Object value = JdbcUtils.getResultSetValueForSimpleType(
                                rs, columnName, type);
     ...
     * @see [类、类#方法、类#成员]
     */
    public RowCallbackHandler getSelectRowCallbackHandler(
            Object newObjInstance) {
        AssertUtils.notNull(this.classReflector, "classReflector is null");
    ...
    public String querySql(Object obj) {
        ...
        if (!ObjectUtils.isEmpty(obj)) {
            MetaObject metaObject = MetaObjectUtils.forObject(obj);
            for (Entry<String, String> entryTemp : queryConditionKey2SqlMapping
                    .entrySet()) {
            ...
            res = new PreparedStatementSetter() {
                ...
                public void setValues(PreparedStatement ps)
                    ...
                    for (Entry<String, String> entryTemp : queryConditionKey2SqlMapping
                        ...
                        JdbcType jdbcType = queryConditionKey2JdbcTypeMapping
                                .get(queryKeyName);
                        JdbcUtils.setPreparedStatementValueForSimpleType(ps,
                                i,
                                valueObj,
    ...
    public PreparedStatementSetter getPagedQueryCondtionSetter(Object obj,
        ...
        final boolean isSupportsLimit = dialect.supportsLimit();//是否支持limit
        final boolean isSupportsLimitOffset = dialect.supportsLimitOffset();//是否支持offset
        final boolean bindLimitParametersInReverseOrder = dialect
        ...
        PreparedStatementSetter res = new PreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps) throws SQLException {
                ...
                for (String propertyNameTemp : updateAblePropertyNames) {
                    ...
                    Class<?> setterType = getter2JavaTypeMapping
                            .get(propertyNameTemp);
                    JdbcUtils.setPreparedStatementValueForSimpleType(ps,
                            i++,
                            valueObj,
                            setterType);
    ...
    public Object clone() throws CloneNotSupportedException {
        ServiceLoggerParser<T> cloneObj = (ServiceLoggerParser<T>) super.clone();
        return cloneObj;
    }
