 ...
 * @since [产品/模块版本]
 */
public class ServiceLoggerImpl<T> extends ServiceLoggerFactory implements LoggerService<T> {
    ...
    public Object getAttribute(String key) {
        return ServiceLoggerSession.getContext().getAttribute(key);
    }
    ...
    public void setAttribute(String key, Object value) {
        ServiceLoggerSession.getContext().setAttribute(key, value);
    }
