...
import com.tx.component.messagerouter.internal.sms.alidayu.AlidayuSMSRequest;
import com.tx.component.messagerouter.internal.sms.alidayu.AlidayuSMSTemplate;
...
public class MRSContextTest {
    ...
    public void test() throws InterruptedException {
        ...
        MRSResponse response = MRSContext.getContext().post(request);
