...
import com.tx.component.messagerouter.context.AbstractMRSReceiver;
import com.tx.component.messagerouter.context.DefaultResponse;
import com.tx.component.messagerouter.context.MRSReceiver;
...
public class AlidayuSMSReceiver
    ...
    public void doHandle(AlidayuSMSRequest request, DefaultResponse<AlibabaAliqinFcSmsNumSendResponse> response) {
        ...
        try {
            ...
            throw new MRSException(e, "阿里大鱼-短信 api 调用失败 : {}", request.toString());
        }
    }
