 ...
 * @since  [产品/模块版本]
 */
public interface BasicDataTypeDao {
    
    /**
     * 批量插入BasicDataType对象实体
     * 1、auto generate
     * <功能详细描述>
     ...
     * 批量更新BasicDataType实体，
     * auto generate
     * 1、传入BasicDataType中主键不能为空
     * <功能详细描述>
     * @param updateBasicDataTypeRowMap
     * @return [参数说明]
     * 
     * @return int [返回类型说明]
     * @exception throws [异常类型] [异常说明]
    ...
    /**
     * 根据指定查询条件以及排序列查询BasicDataType列表
     * auto generate
     * <功能详细描述>
     * @param params
     * @param orderList
     ...
     * @return [参数说明]
     * 
     * @return PagedList<BasicDataType> [返回类型说明]
     * @exception throws [异常类型] [异常说明]
     * @see [类、类#方法、类#成员]
     */
    //auto generate
